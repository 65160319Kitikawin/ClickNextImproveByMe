        ...
        <div class="" style="width: 100%;">
            ...
            <ul class="nav nav-tabs flex-row" role="tablist" style="height: 55px;">
                ...
                <?php $__currentLoopData = array_reverse($collection_tabs); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $collection): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li class="nav-items">
                        <button class="nav-link fst-italic <?php if(request()->routeIs('workspace.editCollection') && request('collection') == $collection->id): ?> active <?php endif; ?>"
                            onclick="window.location='<?php echo e(route('workspace.editCollection', ['workspace' => $selectedWorkspace->id, 'collection' => $collection->id])); ?>'"
                            role="tab" id="view_<?php echo e($collection->id); ?>" data-bs-toggle="tab">
                            <?php echo e($collection->name); ?>

                            <a class="btn fs-5 p-0 material-symbols-outlined"
                                href='<?php echo e(route('delete.collection.tabs', ['workspace' => $selectedWorkspace->id, 'collection' => $collection->id])); ?>'">close</a>
                        </button>
                    </li>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <a style="text-decoration: none"
                    href="<?php echo e(route('workspace.editCollection', ['workspace' => $selectedWorkspace->id, 'collection' => -1])); ?>"
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ClickNextImproveByMe\resources\views/collection.blade.php ENDPATH**/ ?>